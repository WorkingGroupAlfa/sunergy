...
export async function PUT(request: Request) {
  ...
  try {
    ...
    console.error(error);
    return NextResponse.json({ error: 'Unable to save case' }, { status: 500, headers: noStoreHeaders });
  }
}
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    console.error(error);
    return NextResponse.json({ error: 'Unable to delete case' }, { status: 500, headers: noStoreHeaders });
  }
}
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error(error);
    return NextResponse.json({ error: 'Unable to reset cases' }, { status: 500, headers: noStoreHeaders });
  }
}
