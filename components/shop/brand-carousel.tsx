...
export function BrandCarousel({ title = 'Працюємо з брендами' }: { title?: string }) {
  const rows = [...brandLogos, ...brandLogos];

  return (
    <section className="border-y border-line bg-frost/60 py-10">
      <div className="section-shell">
        <div className="mb-4 text-center text-xs font-semibold uppercase tracking-[0.2em] text-accent">{title}</div>
